<%@page import="com.dongzeviva.weixin.common.TConstant"%>
		...
		<div class="main-right">
			<div>
				<div class="alert alert-wx">
					微信AppId：<input type="text" name="appid"
						style="width: 650px; margin-left: 30px;" class="c-pointer"
						readonly="readonly"
						value="<%=publicNumber.getApp_id() == null ? "请填写您微信公众号的APPID" : publicNumber.getApp_id()%>">
					<br />
					<br />微信AppSecret：<input type="text" name="appSecret"
						style="width: 650px;" class="c-pointer" readonly="readonly"
						value="<%=publicNumber.getApp_secret() == null ? "请填写您微信公众号的APPSECRET" : publicNumber.getApp_secret()%>">
				</div>
				<br />
				<div>
					<span style="color: red;">TIP</span>：微信AppId和微信AppSecret需要到<a
						href="https://mp.weixin.qq.com/" target="blank">腾讯微信管理后台</a>获取 <br />
					<br />
					<button class="btn btn-edit" event="wx-update-appid"
						style="margin-top: -58px !important; float: right; width: 120px; height: 40px;">修
						改</button>
				</div>
			...
			<div style="margin-bottom: 18px;">
				<div style="cursor: pointer; width: 150px;" data-toggle="modal"
					data-target="#menu_add_dialog" id="div_add_parent_menu">
					<img src="img/icon-add-menu.jpg">
					<div style="margin-top: -24px; font-size: 20px; margin-left: 30px;">添加一级菜单</div>
				</div>
			</div>
			<div style="margin-left: 5px; width: 828px;">
				<table id="wx-menu-table"
					class="table table-hover table-bordered table-menu"
			...
			<!-- Modal 删除菜单 -->
			<div class="modal fade" id="menu_del_dialog" role="dialog"
				aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body menu_del_dialog">确认要删除该菜单吗</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-submit"
								style="width: 120px;" event="del_menu">是的</button>
			...
			<!-- Modal 添加微信菜单-->
			<div class="modal fade" id="menu_add_dialog" role="dialog"
				aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-body menu_add_dialog">
							<table>
								<tr>
									...
									<td><input type="text" style="width: 350px;" value=""
										name="menu_name"></td>
								</tr>
								<tr>
									<th>事件类型：</th>
								...
								<tr>
									<th>排序：</th>
									<td><input type="text" style="width: 100%;" value="0"
										name="menu_compare"></td>
								</tr>
							</table>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-submit"
								style="width: 120px;" event="add_menu">添加</button>
							<button type="button" class="btn btn-edit" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
			...
			<!-- Modal 更新微信菜单-->
			<div class="modal fade" id="menu_update_dialog" role="dialog"
				aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-body menu_add_dialog">
							<table>
								...
								<tr>
									<th>排序：</th>
									<td><input type="text" style="width: 100%;" value="0"
										name="menu_compare_u"></td>
								</tr>
							</table>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-submit"
								style="width: 120px;" event="update_menu">更新</button>
							<button type="button" class="btn btn-edit" data-dismiss="modal">取消</button>
						</div>
					</div>
					<!-- /.modal-content -->
			...
			<div class="btn-group dropup" style="display: none;">
				<a class="btn dropdown-toggle" style="width: 166px;"
					data-toggle="dropdown" href="#"> Action <span class="caret"></span>
				</a>
