...
import com.dongzeviva.weixin.weixin.common.WXPaySecurityUtils;
...
public class WeixinPayNotifyServletV2 extends HttpServlet {
	...
	private static final String paySignKey = PropUtil.getProperty("server.weixin.pay.signkey");
	// 微信支付回调通知url
	private static final String zfNotifyUrl = PropUtil.getProperty("server.soa.orderform.paynotify");
//	private static final String dsNotifyUrl = SharedBundle.getProperties("server.soa.activity.paynotify");
	private static final String czNotifyUrl = PropUtil.getProperty("server.soa.usercenter.paynotify");
