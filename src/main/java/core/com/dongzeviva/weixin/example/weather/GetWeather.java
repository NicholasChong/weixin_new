...
public class GetWeather {
	...
	private static SOAResponseMessage getFreshWeather(String city) throws RemoteException{
		...
		WeatherWebServiceStub.GetWeatherbyCityName getWeatherbyCityName4 = new WeatherWebServiceStub.GetWeatherbyCityName();
		getWeatherbyCityName4.setTheCityName(city);
		WeatherWebServiceStub.GetWeatherbyCityNameResponse response2 = stub.getWeatherbyCityName(getWeatherbyCityName4);
