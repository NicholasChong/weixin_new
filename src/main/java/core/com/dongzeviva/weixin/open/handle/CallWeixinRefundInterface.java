...
public class CallWeixinRefundInterface extends AbstractWeixinSOAServieHandle {
	...
	private static final String op_user_id =PropUtil.getProperty("server.weixin.pay.opuserid");
	private static final String cer = PropUtil.getProperty("server.weixin.refund.cerlocation");
