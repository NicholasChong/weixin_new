...
public class WeixinTemplateMessageBuilder4Prop {
	...
	private static Map<String, $WeixinTemplateMessageHandle> weixinTemplateMessageHandles = new HashMap<String, $WeixinTemplateMessageHandle>(){
		...
		private String template_czcg = PropUtil.getProperty("server.weixin.template.czcg");
		private String template_ddsl = PropUtil.getProperty("server.weixin.template.ddsl");
		private String template_tkcg = PropUtil.getProperty("server.weixin.template.tkcg");
