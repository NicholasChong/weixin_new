...
import com.dongzeviva.weixin.utils.MsgQueueSender;
...
public class WeixinMessageServiceImpl implements WeixinMessageService {
	...
	private static final String sendJms = PropUtil.getProperty("server.soa.weixin.sendJms");

	private static final String srcsys = PropUtil.getProperty("server.soa.weixin.srcsys");
