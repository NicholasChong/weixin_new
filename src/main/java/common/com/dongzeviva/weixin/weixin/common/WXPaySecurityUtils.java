...
public class WXPaySecurityUtils {
	...
	public static JSONObject vaildateWXPaySign4TeaFormMcake(HttpServletRequest req, String key) throws Throwable {
		...
		if (StringUtils.isBlank(api_name) || StringUtils.isBlank(api_token) || StringUtils.isBlank(noncestr)
	 ...
	 * @throws Throwable
	 */
	public static JSONObject vaildateWXPaySign4V2(HttpServletRequest req, String key, String paySignKey)
			throws Throwable {
