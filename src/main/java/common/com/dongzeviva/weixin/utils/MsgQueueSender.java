...
public class MsgQueueSender {
	...
	private void initMsgQueue() {
		...
		queueName = PropUtil.getProperty("server.soa.weixin.jms.queueName");
		jmsUrl = PropUtil.getProperty("server.soa.weixin.jms.url");
		jmsName = PropUtil.getProperty("server.soa.weixin.jms.name");
		jmsPass = PropUtil.getProperty("server.soa.weixin.jms.pass");
		try {
